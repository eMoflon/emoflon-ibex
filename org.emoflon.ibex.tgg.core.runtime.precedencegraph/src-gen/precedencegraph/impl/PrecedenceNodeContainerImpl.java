 ...
 * @generated
 */
public class PrecedenceNodeContainerImpl extends MinimalEObjectImpl.Container implements PrecedenceNodeContainer {
	/**
	...
	public EList<PrecedenceNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<PrecedenceNode>(PrecedenceNode.class, this, PrecedencegraphPackage.PRECEDENCE_NODE_CONTAINER__NODES);
		}
		return nodes;
	}
