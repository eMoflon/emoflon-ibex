...
public class PrecedencegraphPackageImpl extends EPackageImpl implements PrecedencegraphPackage {
	...
	public static PrecedencegraphPackage init() {
		if (isInited) return (PrecedencegraphPackage)EPackage.Registry.INSTANCE.getEPackage(PrecedencegraphPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPrecedencegraphPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PrecedencegraphPackageImpl thePrecedencegraphPackage = registeredPrecedencegraphPackage instanceof PrecedencegraphPackageImpl ? (PrecedencegraphPackageImpl)registeredPrecedencegraphPackage : new PrecedencegraphPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(precedenceNodeContainerEClass, PrecedenceNodeContainer.class, "PrecedenceNodeContainer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrecedenceNodeContainer_Nodes(), this.getPrecedenceNode(), null, "nodes", null, 0, -1, PrecedenceNodeContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(precedenceNodeEClass, PrecedenceNode.class, "PrecedenceNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPrecedenceNode_Broken(), ecorePackage.getEBoolean(), "broken", null, 0, 1, PrecedenceNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceNode_Requires(), this.getPrecedenceNode(), this.getPrecedenceNode_RequiredBy(), "requires", null, 0, -1, PrecedenceNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceNode_RequiredBy(), this.getPrecedenceNode(), this.getPrecedenceNode_Requires(), "requiredBy", null, 0, -1, PrecedenceNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceNode_BasedOn(), this.getPrecedenceNode(), this.getPrecedenceNode_BaseFor(), "basedOn", null, 0, -1, PrecedenceNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceNode_BaseFor(), this.getPrecedenceNode(), this.getPrecedenceNode_BasedOn(), "baseFor", null, 0, -1, PrecedenceNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPrecedenceNode_MatchAsString(), ecorePackage.getEString(), "matchAsString", null, 0, 1, PrecedenceNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
