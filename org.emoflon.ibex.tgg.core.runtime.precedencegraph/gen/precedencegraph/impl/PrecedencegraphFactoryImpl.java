...
public class PrecedencegraphFactoryImpl extends EFactoryImpl implements PrecedencegraphFactory {
	...
	public static PrecedencegraphFactory init() {
		try {
			PrecedencegraphFactory thePrecedencegraphFactory = (PrecedencegraphFactory) EPackage.Registry.INSTANCE
					.getEFactory(PrecedencegraphPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case PrecedencegraphPackage.PRECEDENCE_NODE_CONTAINER:
			return createPrecedenceNodeContainer();
		case PrecedencegraphPackage.PRECEDENCE_NODE:
			return createPrecedenceNode();
		default:
