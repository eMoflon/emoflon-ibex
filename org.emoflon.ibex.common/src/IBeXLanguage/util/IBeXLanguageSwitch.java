 ...
 * @generated
 */
public class IBeXLanguageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case IBeXLanguagePackage.IBE_XATTRIBUTE: {
		...
		case IBeXLanguagePackage.IBE_XCONTEXT: {
		...
		case IBeXLanguagePackage.IBE_XNAMED_ELEMENT: {
		...
		case IBeXLanguagePackage.IBE_XPATTERN: {
		...
		case IBeXLanguagePackage.IBE_XSTOCHASTIC_ATTRIBUTE_VALUE: {
		...
		case IBeXLanguagePackage.IBE_XARITHMETIC_VALUE: {
