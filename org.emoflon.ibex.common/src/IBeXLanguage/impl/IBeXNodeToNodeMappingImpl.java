 ...
 * </p>
 * <ul>
 *   <li>{@link IBeXLanguage.impl.IBeXNodeToNodeMappingImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link IBeXLanguage.impl.IBeXNodeToNodeMappingImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IBeXNodeToNodeMappingImpl extends EObjectImpl implements BasicEMap.Entry<IBeXNode, IBeXNode> {
	/**
	...
	protected EClass eStaticClass() {
		return IBeXLanguagePackage.Literals.IBE_XNODE_TO_NODE_MAPPING;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IBeXLanguagePackage.IBE_XNODE_TO_NODE_MAPPING__KEY:
			if (resolve)
				return getTypedKey();
			return basicGetTypedKey();
		case IBeXLanguagePackage.IBE_XNODE_TO_NODE_MAPPING__VALUE:
			if (resolve)
