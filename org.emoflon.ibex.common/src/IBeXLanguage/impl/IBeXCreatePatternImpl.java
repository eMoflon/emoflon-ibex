 ...
 * </p>
 * <ul>
 *   <li>{@link IBeXLanguage.impl.IBeXCreatePatternImpl#getAttributeAssignments <em>Attribute Assignments</em>}</li>
 *   <li>{@link IBeXLanguage.impl.IBeXCreatePatternImpl#getContextNodes <em>Context Nodes</em>}</li>
 *   <li>{@link IBeXLanguage.impl.IBeXCreatePatternImpl#getCreatedEdges <em>Created Edges</em>}</li>
 *   <li>{@link IBeXLanguage.impl.IBeXCreatePatternImpl#getCreatedNodes <em>Created Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IBeXCreatePatternImpl extends IBeXPatternImpl implements IBeXCreatePattern {
	...
	protected EClass eStaticClass() {
		return IBeXLanguagePackage.Literals.IBE_XCREATE_PATTERN;
	}
