 ...
 * <ul>
 *   <li>{@link IBeXLanguage.impl.IBeXEnumLiteralImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IBeXEnumLiteralImpl extends IBeXAttributeValueImpl implements IBeXEnumLiteral {
	...
	protected EClass eStaticClass() {
		return IBeXLanguagePackage.Literals.IBE_XENUM_LITERAL;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IBeXLanguagePackage.IBE_XENUM_LITERAL__LITERAL:
			if (resolve)
				return getLiteral();
