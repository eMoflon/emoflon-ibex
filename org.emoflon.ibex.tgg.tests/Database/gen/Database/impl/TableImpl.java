 ...
 *   <li>{@link Database.impl.TableImpl#getHeading <em>Heading</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends EObjectImpl implements Table {
	...
	public void setHeading(String newHeading) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatabasePackage.TABLE__HEADING, oldHeading, heading));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DatabasePackage.TABLE__COLUMNS:
			return getColumns();
		case DatabasePackage.TABLE__HEADING:
			return getHeading();
		}
