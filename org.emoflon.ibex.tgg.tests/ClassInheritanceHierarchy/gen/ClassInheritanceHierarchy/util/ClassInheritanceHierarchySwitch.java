 ...
 * @generated
 */
public class ClassInheritanceHierarchySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ClassInheritanceHierarchySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ClassInheritanceHierarchyPackage.NAMED_ELEMENT: {
...
} //ClassInheritanceHierarchySwitch
