 ...
 * <ul>
 *   <li>{@link SimpleFamilies.impl.FamilyMemberImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FamilyMemberImpl extends EObjectImpl implements FamilyMember {
	...
	protected EClass eStaticClass() {
		return SimpleFamiliesPackage.Literals.FAMILY_MEMBER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleFamiliesPackage.FAMILY_MEMBER__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SimpleFamiliesPackage.FAMILY_MEMBER__NAME:
			return getName();
		}
