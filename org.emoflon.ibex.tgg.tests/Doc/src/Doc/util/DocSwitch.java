...
public class DocSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DocPackage.FOLDER: {
				Folder folder = (Folder)theEObject;
				T result = caseFolder(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DocPackage.FILE: {
				File file = (File)theEObject;
				T result = caseFile(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DocPackage.BINARY_FILE: {
			...
			case DocPackage.DOC_FILE: {
				DocFile docFile = (DocFile)theEObject;
				T result = caseDocFile(docFile);
				if (result == null) result = caseFile(docFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDocFile(DocFile object) {
		return null;
	}
