...
public class TGGAttributeConstraintParameterDefinitionImpl extends EObjectImpl
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.TGG_ATTRIBUTE_CONSTRAINT_PARAMETER_DEFINITION;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case LanguagePackage.TGG_ATTRIBUTE_CONSTRAINT_PARAMETER_DEFINITION__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		case LanguagePackage.TGG_ATTRIBUTE_CONSTRAINT_PARAMETER_DEFINITION__NAME:
			return getName();
		}
