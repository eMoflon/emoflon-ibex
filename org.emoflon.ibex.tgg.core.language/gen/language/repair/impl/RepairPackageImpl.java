...
public class RepairPackageImpl extends EPackageImpl implements RepairPackage {
	...
	public static RepairPackage init() {
		...
		RepairPackageImpl theRepairPackage = registeredRepairPackage instanceof RepairPackageImpl ? (RepairPackageImpl) registeredRepairPackage : new RepairPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(externalShortcutRuleEClass, ExternalShortcutRule.class, "ExternalShortcutRule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExternalShortcutRule_SourceRule(), theLanguagePackage.getTGGRule(), null, "sourceRule", null, 0, 1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExternalShortcutRule_TargetRule(), theLanguagePackage.getTGGRule(), null, "targetRule", null, 0, 1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExternalShortcutRule_Deletions(), theLanguagePackage.getTGGRuleElement(), null, "deletions", null, 0, -1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExternalShortcutRule_Creations(), theLanguagePackage.getTGGRuleElement(), null, "creations", null, 0, -1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExternalShortcutRule_UnboundSrcContext(), theLanguagePackage.getTGGRuleElement(), null, "unboundSrcContext", null, 0, -1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExternalShortcutRule_UnboundTrgContext(), theLanguagePackage.getTGGRuleElement(), null, "unboundTrgContext", null, 0, -1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExternalShortcutRule_Mapping(), this.getTGGRuleElementMapping(), null, "mapping", null, 0, -1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExternalShortcutRule_Name(), ecorePackage.getEString(), "name", null, 0, 1, ExternalShortcutRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(tggRuleElementMappingEClass, TGGRuleElementMapping.class, "TGGRuleElementMapping", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTGGRuleElementMapping_SourceRuleElement(), theLanguagePackage.getTGGRuleElement(), null, "sourceRuleElement", null, 0, 1, TGGRuleElementMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTGGRuleElementMapping_TargetRuleElement(), theLanguagePackage.getTGGRuleElement(), null, "targetRuleElement", null, 0, 1, TGGRuleElementMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
