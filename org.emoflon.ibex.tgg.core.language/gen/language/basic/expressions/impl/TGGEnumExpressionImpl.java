...
public class TGGEnumExpressionImpl extends TGGExpressionImpl implements TGGEnumExpression {
		...
		if (eenum != null && eenum.eIsProxy()) {
			...
			if (eenum != oldEenum) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.TGG_ENUM_EXPRESSION__EENUM, oldEenum, eenum));
			}
		}
		return eenum;
	}
	...
	public void setEenum(EEnum newEenum) {
		...
		eenum = newEenum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.TGG_ENUM_EXPRESSION__EENUM, oldEenum, eenum));
	}
	...
	public EEnumLiteral getLiteral() {
		if (literal != null && literal.eIsProxy()) {
			...
			if (literal != oldLiteral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.TGG_ENUM_EXPRESSION__LITERAL, oldLiteral, literal));
			}
		}
		return literal;
	}
	...
	public void setLiteral(EEnumLiteral newLiteral) {
		...
		literal = newLiteral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.TGG_ENUM_EXPRESSION__LITERAL, oldLiteral, literal));
	}
