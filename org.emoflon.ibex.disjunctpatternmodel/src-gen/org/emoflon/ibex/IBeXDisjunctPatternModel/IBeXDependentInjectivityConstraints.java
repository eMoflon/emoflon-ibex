 ...
 *   <li>{@link org.emoflon.ibex.IBeXDisjunctPatternModel.IBeXDependentInjectivityConstraints#getAttributeConstraints <em>Attribute Constraints</em>}</li>
 * </ul>
 *
...
public interface IBeXDependentInjectivityConstraints extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link org.emoflon.ibex.IBeXDisjunctPatternModel.IBeXDependentDisjunctAttribute#getInjectivityConstraints <em>Injectivity Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Attribute Constraints</em>' reference list.
	 * @see org.emoflon.ibex.IBeXDisjunctPatternModel.IBeXDisjunctPatternModelPackage#getIBeXDependentInjectivityConstraints_AttributeConstraints()
