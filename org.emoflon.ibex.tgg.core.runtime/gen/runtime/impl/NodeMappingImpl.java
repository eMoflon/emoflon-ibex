 ...
 * @generated
 */
public class NodeMappingImpl extends EObjectImpl implements BasicEMap.Entry<String, EObject> {
	/**
	...
	protected EClass eStaticClass() {
		return RuntimePackage.Literals.NODE_MAPPING;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RuntimePackage.NODE_MAPPING__KEY, oldKey, key));
	}
	...
	public EObject getTypedValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RuntimePackage.NODE_MAPPING__VALUE,
							oldValue, value));
			}
		}
		return value;
	...
	public void setTypedValue(EObject newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RuntimePackage.NODE_MAPPING__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RuntimePackage.NODE_MAPPING__KEY:
			return getTypedKey();
		case RuntimePackage.NODE_MAPPING__VALUE:
			if (resolve)
