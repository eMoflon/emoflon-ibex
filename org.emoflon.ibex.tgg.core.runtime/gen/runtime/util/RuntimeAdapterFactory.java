...
public class RuntimeAdapterFactory extends AdapterFactoryImpl {
	...
	protected RuntimeSwitch<Adapter> modelSwitch = new RuntimeSwitch<Adapter>() {
		...
		@Override
		public Adapter caseNodeMapping(Map.Entry<String, EObject> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Node Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
