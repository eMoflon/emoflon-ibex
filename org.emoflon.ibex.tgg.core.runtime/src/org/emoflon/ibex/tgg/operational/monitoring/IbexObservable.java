...
/**
 * Classes implementing the IBex Observable interface can be observed by the IbexObservers.
 * Registered Observers get notified upon possible status changes in the observed object.
 *	
 */
public interface IbexObservable {
	 ...
	 * Notifies observers of this event.
	 */
	public void notifyStartLoading();
	
	/**
	 * Called when loading has ended.
	 * Notifies observers of this event.
	 */
