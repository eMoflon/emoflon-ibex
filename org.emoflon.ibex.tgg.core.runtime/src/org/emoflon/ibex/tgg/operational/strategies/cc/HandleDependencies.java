...
public class HandleDependencies {
	...
	Object2ObjectOpenCustomHashMap<RuntimeEdge, IntOpenHashSet> edgeToMarkingMatches = new Object2ObjectOpenCustomHashMap<>(
	 ...
	 */
	public List<IntOpenHashSet> getComplementRuleApplications(int detectedCycle) {
		List<IntOpenHashSet> bundleToComplementRuleApplication = new ArrayList<>();
