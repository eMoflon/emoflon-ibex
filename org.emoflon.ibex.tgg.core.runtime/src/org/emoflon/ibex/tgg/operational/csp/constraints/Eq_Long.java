...
public class Eq_Long extends RuntimeTGGAttributeConstraint implements EqValueGenerator {
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -EQ_LONG- needs exactly two variables");
