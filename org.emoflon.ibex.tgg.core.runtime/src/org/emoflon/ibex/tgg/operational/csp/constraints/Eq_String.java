...
public class Eq_String extends RuntimeTGGAttributeConstraint implements EqValueGenerator {
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -EQ_STRING- needs exactly two variables");
