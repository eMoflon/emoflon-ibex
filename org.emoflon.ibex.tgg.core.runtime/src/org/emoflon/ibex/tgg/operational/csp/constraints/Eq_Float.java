...
public class Eq_Float extends RuntimeTGGAttributeConstraint implements EqValueGenerator
{
    ...
    */
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -EQ_FLOAT- needs exactly two variables");
