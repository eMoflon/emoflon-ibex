...
public class Eq_Int extends RuntimeTGGAttributeConstraint implements EqValueGenerator
{
    ...
    */
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -EQ_EINT- needs exactly two variables");
