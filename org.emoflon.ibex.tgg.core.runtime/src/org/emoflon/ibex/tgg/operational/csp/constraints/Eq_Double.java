...
public class Eq_Double extends RuntimeTGGAttributeConstraint implements EqValueGenerator
{
    ...
    */
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -EQ_DOUBLE- needs exactly two variables");
