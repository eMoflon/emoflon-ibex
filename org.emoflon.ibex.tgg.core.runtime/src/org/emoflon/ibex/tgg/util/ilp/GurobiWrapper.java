...
final class GurobiWrapper extends ILPSolver {
	 ...
	 *            This setting defines the variable range of variables registered at
	 *            Gurobi
	 */
	...
	private void registerVariable(int variableId) throws GRBException {
		...
		if (onlyBinaryVariables) {
			...
			gurobiVariables.put(variableId,
					model.addVar(Integer.MIN_VALUE, Integer.MAX_VALUE, 0.0, GRB.INTEGER, variable));
		}
	}
	...
	private void registerConstraint(ILPConstraint constraint) throws GRBException {
		...
		model.addConstr(createGurobiExpression(constraint.getLinearExpression()), gurobiComparator,
