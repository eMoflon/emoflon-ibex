...
public class FilterNACAnalysisOwn extends FilterNACAnalysis {
	...
	public FilterNACAnalysisOwn(TGG tgg, IbexOptions options) {
		super(tgg, options);
		this.tgg = tgg;
...
//		return new MaxIncidentEdgeCount(0, null, null);
	...
	//TODO change to normal int and return edgeCounter
