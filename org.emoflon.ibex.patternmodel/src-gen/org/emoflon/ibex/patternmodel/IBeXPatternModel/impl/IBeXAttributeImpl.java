 ...
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXAttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXAttributeImpl#getNode <em>Node</em>}</li>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IBeXAttributeImpl extends MinimalEObjectImpl.Container implements IBeXAttribute {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IBeXPatternModelPackage.IBE_XATTRIBUTE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EAttribute newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IBeXPatternModelPackage.IBE_XATTRIBUTE__TYPE, oldType,
					type));
	}
	...
	public IBeXNode getNode() {
		if (node != null && node.eIsProxy()) {
			...
			if (node != oldNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IBeXPatternModelPackage.IBE_XATTRIBUTE__NODE, oldNode, node));
			}
		}
		return node;
	}
	...
	public void setNode(IBeXNode newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IBeXPatternModelPackage.IBE_XATTRIBUTE__NODE, oldNode,
					node));
	}
	...
	public NotificationChain basicSetValue(IBeXAttributeValue newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IBeXPatternModelPackage.IBE_XATTRIBUTE__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - IBeXPatternModelPackage.IBE_XATTRIBUTE__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IBeXPatternModelPackage.IBE_XATTRIBUTE__VALUE,
					newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IBeXPatternModelPackage.IBE_XATTRIBUTE__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IBeXPatternModelPackage.IBE_XATTRIBUTE__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		case IBeXPatternModelPackage.IBE_XATTRIBUTE__NODE:
			if (resolve)
				return getNode();
			return basicGetNode();
		case IBeXPatternModelPackage.IBE_XATTRIBUTE__VALUE:
