...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IBex Disjoint Injectivity Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBexDisjointInjectivityConstraintImpl#getPattern1 <em>Pattern1</em>}</li>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBexDisjointInjectivityConstraintImpl#getPattern2 <em>Pattern2</em>}</li>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBexDisjointInjectivityConstraintImpl#getNode1 <em>Node1</em>}</li>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBexDisjointInjectivityConstraintImpl#getNode2 <em>Node2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IBexDisjointInjectivityConstraintImpl extends MinimalEObjectImpl.Container
		implements IBexDisjointInjectivityConstraint {
	/**
	 ...
	 * @generated
	 */
	protected IBexDisjointInjectivityConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IBeXPatternModelPackage.Literals.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT;
	}
			...
			if (pattern1 != oldPattern1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__PATTERN1, oldPattern1,
							pattern1));
			}
		}
		return pattern1;
	...
	public void setPattern1(IBeXContextPattern newPattern1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__PATTERN1, oldPattern1, pattern1));
	}
	...
	public IBeXContextPattern getPattern2() {
		if (pattern2 != null && pattern2.eIsProxy()) {
			...
			if (pattern2 != oldPattern2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__PATTERN2, oldPattern2,
							pattern2));
			}
		}
		return pattern2;
	...
	public void setPattern2(IBeXContextPattern newPattern2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__PATTERN2, oldPattern2, pattern2));
	}
	...
	public EList<IBeXNode> getNode1() {
		if (node1 == null) {
			node1 = new EObjectResolvingEList<IBeXNode>(IBeXNode.class, this,
					IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__NODE1);
		}
		return node1;
	}
	...
	public EList<IBeXNode> getNode2() {
		if (node2 == null) {
			node2 = new EObjectResolvingEList<IBeXNode>(IBeXNode.class, this,
					IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__NODE2);
		}
		return node2;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__PATTERN1:
			if (resolve)
				return getPattern1();
			return basicGetPattern1();
		case IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__PATTERN2:
			if (resolve)
				return getPattern2();
			return basicGetPattern2();
		case IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__NODE1:
			return getNode1();
		case IBeXPatternModelPackage.IBEX_DISJOINT_INJECTIVITY_CONSTRAINT__NODE2:
			return getNode2();
		}
...
} //IBexDisjointInjectivityConstraintImpl
