 ...
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeSetImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IBeXNodeSetImpl extends MinimalEObjectImpl.Container implements IBeXNodeSet {
	...
	protected EClass eStaticClass() {
		return IBeXPatternModelPackage.Literals.IBE_XNODE_SET;
	}
	...
	public EList<IBeXNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<IBeXNode>(IBeXNode.class, this,
					IBeXPatternModelPackage.IBE_XNODE_SET__NODES);
		}
		return nodes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IBeXPatternModelPackage.IBE_XNODE_SET__NODES:
