...
public class TGGCorrespondenceImpl extends TGGNodeImpl implements TGGCorrespondence {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IBeXTGGModelPackage.TGG_CORRESPONDENCE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public NotificationChain basicSetSource(TGGNode newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IBeXTGGModelPackage.TGG_CORRESPONDENCE__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSource(TGGNode newSource) {
		if (newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IBeXTGGModelPackage.TGG_CORRESPONDENCE__SOURCE,
					newSource, newSource));
	}
	...
	public TGGNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IBeXTGGModelPackage.TGG_CORRESPONDENCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public NotificationChain basicSetTarget(TGGNode newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IBeXTGGModelPackage.TGG_CORRESPONDENCE__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTarget(TGGNode newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IBeXTGGModelPackage.TGG_CORRESPONDENCE__TARGET,
					newTarget, newTarget));
	}
