...
public class CSPPackageImpl extends EPackageImpl implements CSPPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTGGAttributeConstraintDefinitionLibrary_PackageName(), ecorePackage.getEString(), "packageName", null, 0, 1,
				TGGAttributeConstraintDefinitionLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(tggAttributeConstraintBindingEClass, TGGAttributeConstraintBinding.class, "TGGAttributeConstraintBinding", !IS_ABSTRACT, !IS_INTERFACE,
		...
		initEClass(tggAttributeConstraintSetEClass, TGGAttributeConstraintSet.class, "TGGAttributeConstraintSet", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTGGAttributeConstraintSet_TggAttributeConstraints(), this.getTGGAttributeConstraint(), null, "tggAttributeConstraints", null, 0,
				-1, TGGAttributeConstraintSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTGGAttributeConstraintSet_Parameters(), this.getTGGAttributeConstraintParameterValue(), null, "parameters", null, 0, -1,
				TGGAttributeConstraintSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTGGAttributeConstraintParameterValue_ParameterDefinition(), this.getTGGAttributeConstraintParameterDefinition(), null,
				"parameterDefinition", null, 0, 1, TGGAttributeConstraintParameterValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTGGAttributeConstraintParameterValue_Expression(), theIBeXCoreArithmeticPackage.getValueExpression(), null, "expression", null,
				1, 1, TGGAttributeConstraintParameterValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tggcspEClass, org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.CSP.TGGCSP.class, "TGGCSP", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTGGCSP_Package(), ecorePackage.getEString(), "package", null, 0, 1, org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.CSP.TGGCSP.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTGGCSP_Values(), theIBeXCoreArithmeticPackage.getValueExpression(), null, "values", null, 0, -1,
				org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.CSP.TGGCSP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
