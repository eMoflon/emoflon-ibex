 ...
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.impl.TGGAttributeConstraintLibraryImpl#getTggAttributeConstraints <em>Tgg Attribute Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TGGAttributeConstraintLibraryImpl extends MinimalEObjectImpl.Container
		implements TGGAttributeConstraintLibrary {
	/**
	...
	protected EClass eStaticClass() {
		return IBeXTGGModelPackage.Literals.TGG_ATTRIBUTE_CONSTRAINT_LIBRARY;
	}
	...
	public EList<TGGAttributeConstraint> getTggAttributeConstraints() {
		if (tggAttributeConstraints == null) {
			tggAttributeConstraints = new EObjectContainmentEList<TGGAttributeConstraint>(TGGAttributeConstraint.class,
					this, IBeXTGGModelPackage.TGG_ATTRIBUTE_CONSTRAINT_LIBRARY__TGG_ATTRIBUTE_CONSTRAINTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IBeXTGGModelPackage.TGG_ATTRIBUTE_CONSTRAINT_LIBRARY__TGG_ATTRIBUTE_CONSTRAINTS:
