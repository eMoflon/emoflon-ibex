...
import org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.TGGCSP;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.impl.TGGCSPImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.impl.TGGCSPImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TGGCSPImpl extends IBeXNamedElementImpl implements TGGCSP {
	...
	protected EClass eStaticClass() {
		return IBeXTGGModelPackage.Literals.TGGCSP;
	}
	...
	public void setPackage(String newPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IBeXTGGModelPackage.TGGCSP__PACKAGE, oldPackage,
					package_));
	}
	...
	public EList<ValueExpression> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<ValueExpression>(ValueExpression.class, this,
					IBeXTGGModelPackage.TGGCSP__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IBeXTGGModelPackage.TGGCSP__VALUES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IBeXTGGModelPackage.TGGCSP__PACKAGE:
			return getPackage();
		case IBeXTGGModelPackage.TGGCSP__VALUES:
			return getValues();
		}
