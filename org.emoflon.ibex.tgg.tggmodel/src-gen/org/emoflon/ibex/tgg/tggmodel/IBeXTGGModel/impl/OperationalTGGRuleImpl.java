...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Operational TGG Rule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.ibex.tgg.tggmodel.IBeXTGGModel.impl.OperationalTGGRuleImpl#getOperationalisationMode <em>Operationalisation Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationalTGGRuleImpl extends TGGRuleImpl implements OperationalTGGRule {
	/**
	 ...
	 * @generated
	 */
	protected OperationalTGGRuleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IBeXTGGModelPackage.Literals.OPERATIONAL_TGG_RULE;
	}
	...
	public void setOperationalisationMode(OperationalisationMode newOperationalisationMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IBeXTGGModelPackage.OPERATIONAL_TGG_RULE__OPERATIONALISATION_MODE, oldOperationalisationMode,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IBeXTGGModelPackage.OPERATIONAL_TGG_RULE__OPERATIONALISATION_MODE:
