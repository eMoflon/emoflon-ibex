...
public class IBeXTGGModelPackageImpl extends EPackageImpl implements IBeXTGGModelPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getTGGRuleSet_Rules(), this.getTGGRule(), null, "rules", null, 0, -1, TGGRuleSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		...
		initEReference(getTGGRule_Operationalisations(), this.getTGGOperationalRule(), null, "operationalisations", null, 0, -1, TGGRule.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(tggOperationalRuleEClass, TGGOperationalRule.class, "TGGOperationalRule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getTGGPattern_AttributeConstraints(), theCSPPackage.getTGGAttributeConstraintSet(), null, "attributeConstraints", null, 0, 1,
				TGGPattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEReference(getTGGNode_OutgoingCorrespondence(), this.getTGGCorrespondence(), this.getTGGCorrespondence_Source(), "outgoingCorrespondence",
				null, 0, -1, TGGNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTGGNode_AttributeAssignments(), theIBeXCoreModelPackage.getIBeXAttributeAssignment(), null, "attributeAssignments", null, 0, -1,
				TGGNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTGGNode_ReferencedByConditions(), theIBeXCoreArithmeticPackage.getBooleanExpression(), null, "referencedByConditions", null, 0,
				-1, TGGNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(tggShortcutRuleElementMappingEClass, TGGShortcutRuleElementMapping.class, "TGGShortcutRuleElementMapping", !IS_ABSTRACT, !IS_INTERFACE,
